  ...
  )
{
  ...
  mVariableFv = AllocatePool ((UINTN)((EFI_FIRMWARE_VOLUME_HEADER *)tc4_var_fv)->FvLength);
  if (mVariableFv == NULL) {
    return UNIT_TEST_ERROR_PREREQUISITE_NOT_MET;
  }

  CopyMem (mVariableFv, tc4_var_fv, sizeof (tc4_var_fv));
...
UNIT_TEST_STATUS
EFIAPI
TC4_ProtectedVariableLibInitialize (

  ...
  )
{
  ...
  for (Index = 0; Index < ARRAY_SIZE (mPcdValues); ++Index) {
    if (TokenNumber == mPcdValues[Index].TokenNumber) {
      return (VOID *)&mPcdValues[Index].Value;
    }
  }
  ...
  )
{
  ...
  for (Index = 0; Index < ARRAY_SIZE (mPcdValues); ++Index) {
    ...
    if (mPcdValues[Index].TokenNumber == 0 && PcdIndex == (UINTN)-1) {
      PcdIndex = Index;
    }
  }
  ...
  switch (ValueSize) {
  case sizeof(UINT8):
    mPcdValues[PcdIndex].Value.Value8 = *(UINT8 *)Value;
    break;

  case sizeof(UINT16):
    mPcdValues[PcdIndex].Value.Value16 = *(UINT16 *)Value;
    break;

  case sizeof(UINT32):
    mPcdValues[PcdIndex].Value.Value32 = *(UINT32 *)Value;
    break;

  case sizeof(UINT64):
    mPcdValues[PcdIndex].Value.Value64 = *(UINT64 *)Value;
    break;
  ...
  mPcdValues[PcdIndex].TokenNumber = TokenNumber;
  ...
  )
{
  ...
  Value = PcdGetValueInternal (TokenNumber);
  if (Value != NULL) {
    return *Value;
  }
  return 0;
  ...
  )
{
  ...
  Value = (VOID *)PcdGetValueInternal (TokenNumber);
  if (Value != NULL) {
    return *Value;
  }
...
{
  return LibPcdGet16 (TokenNumber);
}
...
{
  return LibPcdGet64 (TokenNumber);
}
...
{
  return LibPcdGetPtr (TokenNumber);
}
...
{
  return LibPcdGetBool (TokenNumber);
}
...
{
  PcdSetValueInternal (TokenNumber, &Value, sizeof (UINT8));
  return Value;
}
...
{
  PcdSetValueInternal (TokenNumber, &Value, sizeof (UINT16));
  return Value;
}
...
{
  PcdSetValueInternal (TokenNumber, &Value, sizeof (UINT32));
  return Value;
}
...
{
  PcdSetValueInternal (TokenNumber, &Value, sizeof (UINT64));
  return Value;
}
  ...
  )
{
  ...
  Value = AllocatePool (*SizeOfBuffer);
  ASSERT (Value != NULL);

  CopyMem (Value, Buffer, *SizeOfBuffer);
  PcdSetValueInternal (TokenNumber, &Value, sizeof (VOID *));
...
{
  PcdSetValueInternal (TokenNumber, &Value, sizeof (BOOLEAN));
  return Value;
}
...
{
  return LibPcdSet8 (TokenNumber, Value);
}
...
{
  return LibPcdSet16 (TokenNumber, Value);
}
...
{
  return LibPcdSet32 (TokenNumber, Value);
}
...
{
  return LibPcdSet64 (TokenNumber, Value);
}
...
{
  return LibPcdSetPtr (TokenNumber, SizeOfBuffer, Buffer);
}
...
{
  return LibPcdSetBool (TokenNumber, Value);
}
#endif
...
{
  if (PcdSetValueInternal (TokenNumber, &Value, sizeof (UINT8))) {
...
{
  if (PcdSetValueInternal (TokenNumber, &Value, sizeof (UINT16))) {
    return RETURN_SUCCESS;
  }
...
{
  if (PcdSetValueInternal (TokenNumber, &Value, sizeof (UINT32))) {
    return RETURN_SUCCESS;
  }
...
{
  if (PcdSetValueInternal (TokenNumber, &Value, sizeof (UINT64))) {
    return RETURN_SUCCESS;
  }
  ...
  )
{
  ...
  CopyMem (Value, Buffer, *SizeOfBuffer);
  if (PcdSetValueInternal (TokenNumber, &Value, sizeof (VOID *))) {
    return RETURN_SUCCESS;
  }
...
{
  if (PcdSetValueInternal (TokenNumber, &Value, sizeof (BOOLEAN))) {
    return RETURN_SUCCESS;
  }
...
{
  return LibPcdSet8S (TokenNumber, Value);
}
...
{
  return LibPcdSet16S (TokenNumber, Value);
}
...
{
  return LibPcdSet32S (TokenNumber, Value);
}
...
{
  return LibPcdSet64S (TokenNumber, Value);
}
...
{
  return LibPcdSetPtrS (TokenNumber, SizeOfBuffer, Buffer);
}
...
{
  return LibPcdSetBoolS (TokenNumber, Value);
}

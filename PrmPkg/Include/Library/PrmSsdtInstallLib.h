/** @file
  ...
  The PRM SSDT Install library provides functionality to install the PRM SSDT.

  This functionality is scoped to a library class to allow high flexibility for platforms that choose:
...
#ifndef __PRM_SSDT_INSTALL_LIB_H__
#define __PRM_SSDT_INSTALL_LIB_H__

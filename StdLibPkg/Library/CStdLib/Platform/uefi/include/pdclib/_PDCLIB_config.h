...
#define _PDCLIB_cc( x, y )     _CONCATENATE(x, y)
...
/* Bits in a char */
#define _PDCLIB_CHAR_BIT (sizeof (CHAR8) * 8)

/* UEFI note: Base.h macros for min/max values are type-casted and cause      */
/* problems, when used in a preprocessor #if statements.                      */
/* Additionally, MAX_INT64 is defined with ULL post-fix, which generates      */
/* signed/unsigned mismatch warnings in pdclib code.                          */
/* In order to address them both, min/max macros are defined in this file     */
/* and Base.h definitions are not used                                        */
#define UEFI_MIN_INT8       MIN_INT8
#define UEFI_MIN_INT16      MIN_INT16
#define UEFI_MIN_INT32      MIN_INT32
#define UEFI_MIN_INT64      MIN_INT64
#define UEFI_MIN_INTN       MIN_INTN

#define UEFI_MAX_INT8       0x7F
#define UEFI_MAX_UINT8      0xFF
#define UEFI_MAX_INT16      0x7FFF
#define UEFI_MAX_UINT16     0xFFFF
#define UEFI_MAX_INT32      0x7FFFFFFF
#define UEFI_MAX_UINT32     0xFFFFFFFF
#define UEFI_MAX_INT64      0x7FFFFFFFFFFFFFFFLL
#define UEFI_MAX_UINT64     0xFFFFFFFFFFFFFFFFULL

#if defined(MDE_CPU_IA32) || defined (MDE_CPU_ARM)
#define UEFI_MAX_INTN       UEFI_MAX_INT32
#define UEFI_MAX_UINTN      UEFI_MAX_UINT32
#elif defined(MDE_CPU_X64) || defined(MDE_CPU_AARCH64) || defined(MDE_CPU_RISCV64)
#define UEFI_MAX_INTN       UEFI_MAX_INT64
#define UEFI_MAX_UINTN      UEFI_MAX_UINT64
#else
#error "Architecture used is unsupported by StdLibPkg/CStdLib."
#endif

#if defined(_MSC_BUILD)
// MSVC ILP32 and LLP64 - long is 32-bit
#define UEFI_MAX_LONG       UEFI_MAX_INT32
#define UEFI_MIN_LONG       UEFI_MIN_INT32
#define UEFI_MAX_ULONG      UEFI_MAX_UINT32
#elif defined(__GNUC__)
#if defined(MDE_CPU_IA32)
// GCC ILP32 - long is 32-bit
#define UEFI_MAX_LONG       UEFI_MAX_INT32
#define UEFI_MIN_LONG       UEFI_MIN_INT32
#define UEFI_MAX_ULONG      UEFI_MAX_UINT32
#elif defined(MDE_CPU_X64)
// GCC LP64 - long is 64-bit
#define UEFI_MAX_LONG       UEFI_MAX_INT64
#define UEFI_MIN_LONG       UEFI_MIN_INT64
#define UEFI_MAX_ULONG      UEFI_MAX_UINT64
#else
...
#define _PDCLIB_SCHAR_MAX   UEFI_MAX_INT8
#define _PDCLIB_SCHAR_MIN   UEFI_MIN_INT8
#define _PDCLIB_UCHAR_MAX   UEFI_MAX_UINT8

/* Whether the 'char' type is unsigned                                        */
// UEFI note: Chars are signed in UEFI.
...
#define _PDCLIB_SHRT_MAX    UEFI_MAX_INT16
#define _PDCLIB_SHRT_MIN    UEFI_MIN_INT16
#define _PDCLIB_USHRT_MAX   UEFI_MAX_UINT16

/* Maximum and minimum values of signed / unsigned int                        */
#define _PDCLIB_INT_MAX     UEFI_MAX_INT32
#define _PDCLIB_INT_MIN     UEFI_MIN_INT32
#define _PDCLIB_UINT_MAX    UEFI_MAX_UINT32

/* Maximum and minimum values of signed / unsigned long                       */
#define _PDCLIB_LONG_MAX    UEFI_MAX_LONG
#define _PDCLIB_LONG_MIN    UEFI_MIN_LONG
#define _PDCLIB_ULONG_MAX   UEFI_MAX_ULONG

/* Maximum and minimum values of signed / unsigned long long                  */
#define _PDCLIB_LLONG_MAX   UEFI_MAX_INT64
#define _PDCLIB_LLONG_MIN   UEFI_MIN_INT64
#define _PDCLIB_ULLONG_MAX  UEFI_MAX_UINT64
...
#define _PDCLIB_int_fast8_t        INT8
#define _PDCLIB_INT_FAST8_MAX      UEFI_MAX_INT8
#define _PDCLIB_INT_FAST8_MIN      UEFI_MIN_INT8
#define _PDCLIB_uint_fast8_t       UINT8
#define _PDCLIB_UINT_FAST8_MAX     UEFI_MAX_UINT8

/* int_least8_t / uint_least8_t                                               */
#define _PDCLIB_int_least8_t       INT8
#define _PDCLIB_INT_LEAST8_MAX     UEFI_MAX_INT8
#define _PDCLIB_INT_LEAST8_MIN     UEFI_MIN_INT8
#define _PDCLIB_uint_least8_t      UINT8
#define _PDCLIB_UINT_LEAST8_MAX    UEFI_MAX_UINT8

/* int_fast16_t / uint_fast16_t                                               */
#define _PDCLIB_int_fast16_t       INTN
#define _PDCLIB_INT_FAST16_MAX     UEFI_MAX_INTN
#define _PDCLIB_INT_FAST16_MIN     UEFI_MIN_INTN
#define _PDCLIB_uint_fast16_t      UINTN
#define _PDCLIB_UINT_FAST16_MAX    UEFI_MAX_UINTN

/* int_least16_t / uint_least16_t                                             */
#define _PDCLIB_int_least16_t      INT16
#define _PDCLIB_INT_LEAST16_MAX    UEFI_MAX_INT16
#define _PDCLIB_INT_LEAST16_MIN    UEFI_MIN_INT16
#define _PDCLIB_uint_least16_t     UINT16
#define _PDCLIB_UINT_LEAST16_MAX   UEFI_MAX_UINT16

/* int_fast32_t / uint_fast32_t                                               */
#define _PDCLIB_int_fast32_t       INTN
#define _PDCLIB_INT_FAST32_MAX     UEFI_MAX_INTN
#define _PDCLIB_INT_FAST32_MIN     UEFI_MIN_INTN
#define _PDCLIB_uint_fast32_t      UINTN
#define _PDCLIB_UINT_FAST32_MAX    UEFI_MAX_UINTN

/* int_least32_t / uint_least32_t                                             */
#define _PDCLIB_int_least32_t      INT32
#define _PDCLIB_INT_LEAST32_MAX    UEFI_MAX_INT32
#define _PDCLIB_INT_LEAST32_MIN    UEFI_MIN_INT32
#define _PDCLIB_uint_least32_t     UINT32
#define _PDCLIB_UINT_LEAST32_MAX   UEFI_MAX_UINT32

/* int_fast64_t / uint_fast64_t                                               */
#define _PDCLIB_int_fast64_t       INT64
#define _PDCLIB_INT_FAST64_MAX     UEFI_MAX_INT64
#define _PDCLIB_INT_FAST64_MIN     UEFI_MIN_INT64
#define _PDCLIB_uint_fast64_t      UINT64
#define _PDCLIB_UINT_FAST64_MAX    UEFI_MAX_UINT64

/* int_least64_t / uint_least64_t                                             */
#define _PDCLIB_int_least64_t      INT64
#define _PDCLIB_INT_LEAST64_MAX    UEFI_MAX_INT64
#define _PDCLIB_INT_LEAST64_MIN    UEFI_MIN_INT64
#define _PDCLIB_uint_least64_t     UINT64
#define _PDCLIB_UINT_LEAST64_MAX   UEFI_MAX_UINT64
...
#define _PDCLIB_INT_LEAST8_C(c)     ((_PDCLIB_int_least8_t) c)
#define _PDCLIB_UINT_LEAST8_C(c)    ((_PDCLIB_uint_least8_t) _PDCLIB_concat(c, U))
#define _PDCLIB_INT_LEAST16_C(c)    ((_PDCLIB_int_least16_t) c)
#define _PDCLIB_UINT_LEAST16_C(c)   ((_PDCLIB_uint_least16_t) _PDCLIB_concat(c, U))
#define _PDCLIB_INT_LEAST32_C(c)    ((_PDCLIB_int_least32_t) _PDCLIB_concat(c, L))
#define _PDCLIB_UINT_LEAST32_C(c)   ((_PDCLIB_uint_least32_t) _PDCLIB_concat(c, UL))
#define _PDCLIB_INT_LEAST64_C(c)    ((_PDCLIB_int_least64_t) _PDCLIB_concat(c, LL))
#define _PDCLIB_UINT_LEAST64_C(c)   ((_PDCLIB_uint_least64_t) _PDCLIB_concat(c, ULL))
...
#define _PDCLIB_ptrdiff_t   INTN
// #define _PDCLIB_PTRDIFF_MAX MAX_ADDRESS
// #define _PDCLIB_PTRDIFF_MIN _PDCLIB_MIN_CALC(MAX_ADDRESS)
...
// #endif
#define _PDCLIB_SIG_ATOMIC_MAX      UEFI_MAX_INTN
#define _PDCLIB_SIG_ATOMIC_MIN      UEFI_MIN_INTN
...
#define _PDCLIB_size_t   UINTN
#define _PDCLIB_SIZE_MAX UEFI_MAX_UINTN

/* Large enough an integer to hold all character codes of the widest          */
/* supported locale.                                                          */
#define _PDCLIB_wchar_t   CHAR16
// #define _PDCLIB_WCHAR_MAX MAX_INT16
// #define _PDCLIB_WCHAR_MIN _PDCLIB_MIN_CALC(MAX_INT16)

/* Large enough an integer to hold all character codes of the widest          */
/* supported locale plus WEOF (which needs not to be equal to EOF, nor needs  */
/* to be of negative value).                                                  */
#define _PDCLIB_wint_t   INT32
// #define _PDCLIB_WINT_MAX MAX_INT32
// #define _PDCLIB_WINT_MIN _PDCLIB_MIN_CALC(MAX_INT32)
...
#define _PDCLIB_intptr_t     INTN
#define _PDCLIB_INTPTR_MAX   UEFI_MAX_INTN
#define _PDCLIB_INTPTR_MIN   UEFI_MIN_INTN
#define _PDCLIB_uintptr_t    UINTN
#define _PDCLIB_UINTPTR_MAX  UEFI_MAX_UINTN

/* Largest supported integer type. Implementation note: see _PDCLIB_atomax(). */
#define _PDCLIB_intmax_t     INT64
#define _PDCLIB_INTMAX_MAX   UEFI_MAX_INT64
#define _PDCLIB_INTMAX_MIN   UEFI_MIN_INT64
// #define _PDCLIB_INTMAX_C(c)  ((_PDCLIB_intmax_t) _PDCLIB_concat(c, LL))
#define _PDCLIB_uintmax_t    UINT64
#define _PDCLIB_UINTMAX_MAX  UEFI_MAX_UINT64
// #define _PDCLIB_UINTMAX_C(c) ((_PDCLIB_uintmax_t) _PDCLIB_concat(c, ULL))
...
// #else
// #endif
#define _PDCLIB_time_t      INT64
#define _PDCLIB_TIME_MAX    UEFI_MAX_INT64
#define _PDCLIB_TIME_MIN    UEFI_MIN_INT64
...
/* on most compilers.                                                         */
#define _PDCLIB_offsetof( type, member ) OFFSET_OF(type, member)
...
#define _PDCLIB_va_arg    VA_ARG
#define _PDCLIB_va_copy   VA_COPY
#define _PDCLIB_va_end    VA_END
#define _PDCLIB_va_start  VA_START
...
#define __STDC_NO_THREADS           1
#define __STDC_NO_THREADS__         1
#define _PDCLIB_NULL_DEFINED        1

// Extensions
#define _PDCLIB_EXTEND_STRING_H     <extensions/string.h>
#define _PDCLIB_EXTEND_TIME_H       <extensions/time.h>
...
// GCC-only stuff. Why not using stdatomic.h?
#define __ATOMIC_RELAXED      0
#define __ATOMIC_ACQUIRE      2
#define __ATOMIC_RELEASE      3
#define __atomic_compare_exchange_n(ptr, expected, desired, weak, success_memorder, failure_memorder)   BoolAssert(FALSE, ptr, expected, desired, weak, success_memorder, failure_memorder)
#define __atomic_store_n(ptr, val, memorder)                                                            BoolAssert(FALSE, ptr, val, memorder)

// Temporary to avoid MSVC warning
#define __builtin_popcountll(x)     (((x) == 0) ? 0 : 0)

...
[Defines]
  ...
  PLATFORM_GUID                  = 95AA735F-4D5F-4A53-8F16-BFB082C21B02
...
[Components]
  UefiTestingPkg/AuditTests/DMAProtectionAudit/UEFI/VTd/DMAProtectionUnitTestApp.inf
  ...
  UefiTestingPkg/SafeIntLib/SafeIntLibUnitTestsApp.inf
  UefiTestingPkg/SafeIntLib/SafeIntLibUnitTestsPeim.inf
  UefiTestingPkg/SafeIntLib/SafeIntLibUnitTestsSmm.inf
...
[BuildOptions]
  *_*_*_CC_FLAGS = -D DISABLE_NEW_DEPRECATED_INTERFACES
  ...
  GCC:*_*_*_CC_FLAGS = -Wno-unused-but-set-variable -Wno-pointer-to-int-cast -Wno-unknown-pragmas

 ...
 **/
UINTN SpdmFillMeasurementImageHashBlock (
 ...
 * @return measurement block size.
 **/
UINTN SpdmFillMeasurementSvnBlock (
    SPDM_MEASUREMENT_BLOCK_DMTF *measurement_block
    )
{
 ...
 * @return measurement block size.
 **/
UINTN SpdmFillMeasurementManifestBlock (
    SPDM_MEASUREMENT_BLOCK_DMTF *measurement_block
    )
{
 ...
 * @return measurement block size.
 **/
UINTN SpdmFillMeasurementDeviceModeBlock (
    SPDM_MEASUREMENT_BLOCK_DMTF *measurement_block
    )
{
    ...
    CopyMem((void *)(measurement_block + 1),
    ...
    if (measurements_index ==
        ...
        *measurements_count = LIBSPDM_MEASUREMENT_BLOCK_NUMBER;
        ...
        for (index = 1; index <= LIBSPDM_MEASUREMENT_BLOCK_HASH_NUMBER; index++) {
            measurement_block_size = SpdmFillMeasurementImageHashBlock (use_bit_stream,
...
SpdmGenerateMeasurementSummaryHash (
    ...
    case SPDM_CHALLENGE_REQUEST_ALL_MEASUREMENTS_HASH:
        ...
        result = SpdmHashAll (base_hash_algo, measurement_data,
